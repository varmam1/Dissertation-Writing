...
% \begin{center}
%     \texttt{histogram[$\phi_1/20$] += $\frac{\phi_2 - \theta}{20} \times m$}    
% \end{center}
...
We can see an example of this in figure \ref{HOGHistoVisual}.

% \begin{center}
%     \texttt{histogram[$\phi_2/20$] += $\frac{\theta - \phi_1}{20} \times m$}    
% \end{center}
