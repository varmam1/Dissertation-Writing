...
Word Count:         & \bf 11999\footnotemark[1] \\ % TODO: Change
Line Count:         & \bf 3027\footnotemark[2] \\ 
...
I successfully implemented WGEML and was able to recreate the original accuracies within an acceptable range, thus fulfilling my success criterion. Furthermore, I performed ablation studies in order to determine if there is a relationship between the number of face descriptors used and the accuracy of the model and replaced one face descriptor with a less expensive one.  
...
\begin{enumerate}
    ...
    I then explore the consequences of these biases that were found to be present in KinFaceW-II and TSKinFace in section \ref{sec:Biases}.
...
\begin{figure}[ht]
    ...
    \caption[Example of the LBP operator on a pixel]{Example of the LBP operator on a pixel. Image sourced from Matti Pietikäinen \cite{LBPEx}}
